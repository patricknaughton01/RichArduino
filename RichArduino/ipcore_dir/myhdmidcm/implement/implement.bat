...
xst -ifn xst.scr
move myhdmidcm_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\myhdmidcm_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc myhdmidcm_exdes.ucf myhdmidcm_exdes

echo 'Running map'
map -timing -pr b myhdmidcm_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm myhdmidcm_exdes -w routed.ncd routed.vhd
cd ..
